...
const Main = () => {
  return (
    <ColumnCenterContainer style={{ marginTop: '40px' }}>
      <ContentContainer>
        <ContentHeaderContainer>
        ...
        <ContentBodyContainer>
          ...
          <p>
            좋아하는 것을 만들고 이를 통해 사용자의 더 나은 삶에 기여하고자
            합니다.
            <br />
            현재는 대형 에너지 및 공정 설비 시뮬레이션을 통한 디지털 트윈 서비스
            회사에서 데스크톱 App 프론드엔드 개발자로 재직중에 있습니다.
          </p>
